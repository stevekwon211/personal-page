    ...
    return (
        <div className="">
            ...
            <p className="mb-4 mr-40">
                ...
                <br />
                <br />
                이런 문제들이 사람들로 하여금 더 배려깊고 사회에 유익한 것을 창작하지 못하도록 방해합니다. 그래서
                위인들이 더 많이 생겨나고 좋은 창작을 통해 사람들에게 영감을 줄 수 있도록 만들려고 합니다. 이를 위해 IT
                프로덕트 메이커를 위한 소셜 네트워크인 디스콰이엇 팀에서 프로덕트 기획과 GTM, 그외 성공하기 위해 필요한
                모든 것을 하고 있습니다.
            </p>
        </div>
    );
